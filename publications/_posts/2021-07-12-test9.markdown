...
skills: "Python"
---
Trained a MLP on MNIST dataset to detect multiple handwritten digits in real-time.  
Binarized frames using thresholding and dilated digits to find contours in preprocessing to localize digits.
